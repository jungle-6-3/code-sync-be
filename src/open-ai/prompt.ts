    ...
    messages: [
      ...
      },
      {
        ...
        content: [
          {
            type: 'text',
            text: '[{"date":"2024-11-08T05:34:43.574Z","message":"여기 result는 어떻게 해서 나왔니?","name":"user5","email":"user5@github.com"},{"date":"2024-11-08T05:35:12.980Z","message":"음 그냥 flot해서 나왔어요","name":"user7","email":"user7@github.com"},{"date":"2024-11-08T05:35:41.374Z","message":"뭔가 여기 코드는 좀 더 develop하면 좋을 것 같은데","name":"user5","email":"user5@github.com"},{"date":"2024-11-08T05:35:56.690Z","message":"구체적으로 어떻게 develop하면 되나요?","name":"user7","email":"user7@github.com"},{"date":"2024-11-08T05:36:17.568Z","message":"한 번 status design pattern을 써봐","name":"user5","email":"user5@github.com"}]',
          },
        ],
      },
      {
        ...
        content: [
          {
            type: 'text',
            text: JSON.stringify(voiceChatChunk),
          },
        ],
      },
    ],
...
여기서 대화 주제는 주로 코딩과 관련된 내용 위주로 요약해주세요.
마지막엔 전체 내용을 한 문장으로 요약해주세요. 
