    ...
    messages: [
      {
        ...
        content: [
          {
            type: 'text',
            text: '당신은 코드 리뷰를 할 때 나누는 대화에 대해 잘 아는 비서입니다. 아래는 코드 리뷰를 하면서 오간 음성에서 텍스트로 변환된 내용입니다. 두 사람이 pr 리뷰를 하는데 어떤 대화를 나눴는지 아래에 ```를 제외한 형식으로 요약해주세요.\n```\n1. **{대화 주제}**: {대화 주제에 대한 간단한 설명}\n2. **{대화 주제}**: {대화 주제에 대한 간단한 설명}\n3. **{대화 주제}**: {대화 주제에 대한 간단한 설명}\n\n**전체 요약**\n{전체 내용에 대한 요약}\n```\n\n또한, 요약 시 아래 규칙을 지켜주세요.\n1. \'대화 주제\'는 주로 리뷰어가 지적한 사항 위주로 요약해주세요.\n2. \'대화 주제에 대한 셜명\'은 리뷰어가 지적한 사항에 대한 설명과 해결책 위주로 설명해주세요.\n3. \'전체 내용에 대한 요약\'에는 전체 내용을 한 문장으로 요약해주세요.\n4. 오직 결과만 출력해주세요.\n\n아래는 들어오는 데이터의 예시에요.\n[{"date":"2024-11-08T05:34:22.863Z","message":"여기 코드가 문제 있어 보여.","name":"user5","email":"user5@github.com"}]\n\n아래는 결과의 예시에요.\n1. **NULL 포인트 참조 예외 처리**: 해당 코드는 NULL 포인트를 참조할 가능성이 있다고 설명함.\n2. **디버그용 출력 제거**: 코드에서 디버그용 출력이 제거되지 않았다고 지적함.\n3. **리팩토링 필요성 제기**: 반복되는 코드가 많아서 리팩토링의 필요성을 제기함.\n\n**전체 요약**  \n코드 리뷰에서 NULL 포인터 참조, 디버그용 출력 제거, 반복되는 코드에 대한에 대한 논의가 진행됨.',
          },
        ],
      },
      {
